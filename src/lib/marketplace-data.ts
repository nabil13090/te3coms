...
export const MARKETPLACE_PROJECTS: MarketplaceProject[] = [
  ...
  },
  {
    ...
    status: 'live',
    shortDesc: 'Site lavage auto mobile écologique — devis en ligne et intervention à domicile.',
    fullDesc:
      'Vitrine conversion pour une marque fictive de lavage automobile sans eau : parcours devis clair, CTA téléphone / WhatsApp, arguments écologiques et zone d\'intervention. Projet démo portfolio (identité inventée).',
    context:
      'Projet de démonstration TE3COMS — entreprise fictive spécialisée dans le nettoyage automobile à domicile, sans lien avec une marque réelle.',
    challenge:
      'Montrer une landing conversion-first : différenciation « sans eau », preuves chiffrées, et prise de contact rapide sur mobile.',
    solution:
      'Landing orientée conversion : hero véhicule, bandeau preuves, navigation Auto / Maison / Pro, click-to-call et formulaire devis. SEO local générique intégré.',
    deliveryTime: '3 semaines',
    pages: ['Accueil', 'Lavage auto', 'Lavage intérieur', 'Devis', 'Avant / Après', 'Zone d\'intervention', 'Pro', 'Avis', 'Contact'],
    features: [
    ...
    results: [
      ...
      { value: 'Demo', label: 'Projet portfolio' },
      { value: '100%', label: 'Identité fictive' },
    ],
    demoUrl: 'https://te3coms.fr/marketplace/brillago',
    accentColor: '#0EA5E9',
    screenshot: '/screenshots/brillago.png',
  },
  {
    id: 9,
    slug: 'couvreurpro',
